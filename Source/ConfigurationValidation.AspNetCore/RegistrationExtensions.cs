...
public static class RegistrationExtensions
{
    ...
    /// <param name="isDevelopment">Should use builder.Environmet.IsDevelopment() to supply boolean to avoid exposing senditive information in production. (Default = false)</param>
